				...
				if (newQueue.repeatMode == 0) {
					...
					message.reply({
						embeds: [new MessageEmbed()
						  .setColor(ee.color)
						  .setTimestamp()
						  .setTitle(`<a:cleared:945737348967186482> **Enabled the __Queue__-Loop!** <a:djpartys:945543961257332757> ||( <a:music_level:945726294308585484>Disabled the **Song-Loop**)||`)
						  .setFooter(`💢 Action by: ${member.user.tag}`, member.user.displayAvatarURL({dynamic: true}))]
						})
				}
			} catch (e) {
