			...
			try {
				...
				for (let i = 0; i < theSongs.length; i += 10) {
					...
					const embed = new MessageEmbed()
						...
						.setDescription(`${info}`)
					if (i < 10) {
						embed.setTitle(`<:zerotwome:945739819819085884> **Top ${theSongs.length > 50 ? 50 : theSongs.length} |<a:music_level:945726294308585484> Queue of ${guild.name}** <a:djpartys:945543961257332757>`)
