	...
	run: async (client, message, args) => {
		try {
			...
			try {
				...
				//Edit the reply
				newmsg.edit({
					content: `${queue?.songs?.length > 0 ? "<a:check_mark:944952166869778502> Added to the Top of the Queue" : "<a:music_level:945726294308585484> Now Playing <a:djpartys:945543961257332757>"}: \`\`\`css\n${Text}\n\`\`\``,
				}).catch(e => {
					console.log(e)
				})
			} catch (e) {
