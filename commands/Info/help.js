    ...
    try {
      ...
      if (args[0] && args[0].length > 0) {
        ...
        const embed = new MessageEmbed()
          ...
          .setTitle("<a:check_mark:944952166869778502> HELP MENU <a:arrow1:945549636649758742> Commands")
          .setDescription(`<a:Discord_Logo_Animated:945545231871402014> ***Invite me with __Slash Commands__  Permissions*** **[Invite Link!](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot%20applications.commands)**, ***cause all of my Commands are available as Slash Commands too!*** \n\n> <a:special_arrow:945549299620663296> **Check out the [ Dashboard ](${websiteSettings.website.domain}/dashboard/${message.guild.id}) or the [Live Music Queue](${websiteSettings.website.domain}/queue/${message.guild.id})**`)
